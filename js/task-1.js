...
categories.forEach((itemElem) => {
  const categoryTitle = itemElem.querySelector("h2");

  const numberElem = itemElem.querySelectorAll("li");

  console.log(`Category: ${categoryTitle.textContent}`);
  console.log(`Elements: ${numberElem.length}`);
});
